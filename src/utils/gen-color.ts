...
function hexToRGB(hex: string): RGB {
  ...
  const hexValArr = (hexRegExp.exec(hex)?.[1] || '000000').split('') as Array<HEX>
...
function genMixColor(base: string | RGB | HSL): {
  ...
  return {
    ...
    dark: {
      ...
      8: rgbToHex(mix(base, rgbBlack, 0.8)),
      9: rgbToHex(mix(base, rgbBlack, 0.9))
    },
    light: {
      ...
      8: rgbToHex(mix(base, rgbWhite, 0.8)),
      9: rgbToHex(mix(base, rgbWhite, 0.9))
    }
  }
}
